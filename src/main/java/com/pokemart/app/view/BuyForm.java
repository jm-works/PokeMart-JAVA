...
import com.pokemart.app.controller.BuyController;
...
public class BuyForm extends JPanel {
    ...
    public BuyForm(MainForm mainForm) {
        initComponents();
        this.controller = new BuyController(this, mainForm);
    }
    ...
    private void initComponents() {
        ...
        breadcrumb.add(makeHeaderLabel("COMPRAS", PokeTheme.TEXT_PRIMARY));

        JLabel lblTitle = new JLabel("COMPRA DE ESTOQUE");
        ...
        colInfo.add(makePreviewKey("PRECO"));   colInfo.add(lblPreviewPrice);
        ...
        JLabel lblTotalKey = new JLabel("TOTAL DA COMPRA");
        lblTotalKey.setFont(PokeTheme.getPixelFont(7f));
        lblTotalKey.setForeground(PokeTheme.ACCENT_RED);
        lblTotal = new JLabel("₽ 0.00");
        lblTotal.setFont(PokeTheme.getPixelFont(16f));
        lblTotal.setForeground(PokeTheme.ACCENT_RED);
        ...
        btnClear.addActionListener(e -> {
            int ok = JOptionPane.showConfirmDialog(this,
                    "Limpar a lista de compras?", "Atencao",
                    JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if (ok == JOptionPane.YES_OPTION) controller.onClear();
        });

        btnConfirm.addActionListener(e -> controller.onComplete());
    }
